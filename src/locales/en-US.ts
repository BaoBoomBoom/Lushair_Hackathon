...
export default {
  ...
  "wallet_connect_event": "Wallet connect event triggered",
  "attempting_to_connect": "Attempting to connect wallet...",
  "wallet_connected": "Wallet connected",
  "no_wallet_detected": "No wallet detected. Please install Phantom wallet extension.",
  "connecting_wallet": "Connecting wallet...",
  "connection_command_sent": "Connection command sent",
  "found_wallet_button": "Found wallet button, clicking...",
  "wallet_button_not_found": "Wallet button not found, please refresh and try again.",
  "wallet_connection_failed": "Wallet connection failed",
  "wallet_disconnected": "Wallet disconnected",
  "disconnect_failed": "Disconnect failed",
  "transaction_request": "Transaction request, wallet state",
  "connect_wallet_first": "Connect wallet first!",
  "user_info_not_completed": "User information not completed",
  "upload_at_least_one": "Please upload at least one image",
  "successfully_sent": "Successfully sent",
  "uploading_please_wait": "Uploading, please wait...",
  "upload_successful": "Upload successful!",
  "upload_failed": "Upload failed: Please select or take another picture",
